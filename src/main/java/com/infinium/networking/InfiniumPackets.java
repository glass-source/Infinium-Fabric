...
import com.infinium.networking.packets.whitelist.ApplyWhitelistS2CPacket;
...
public class InfiniumPackets {
    ...
    public static final Identifier APPLY_WHITELIST_ID = Infinium.id("apply_whitelist");
    ...
    public static void initS2CPackets(){
        ClientPlayNetworking.registerGlobalReceiver(APPLY_WHITELIST_ID, ApplyWhitelistS2CPacket::receive);
