...
public class KairosClockItem extends Item implements InfiniumItem {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        stateList.add(new PlayerState(sp));
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!(user instanceof ServerPlayerEntity sp)) return super.use(world, user, hand);
        if (sp.getServer() == null) return super.use(world, user, hand);
