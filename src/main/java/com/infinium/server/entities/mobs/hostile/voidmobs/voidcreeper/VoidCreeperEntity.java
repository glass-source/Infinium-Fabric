...
public class VoidCreeperEntity extends CreeperEntity implements InfiniumEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new EscapeDangerGoal(this, 1.55));

    }

    public static DefaultAttributeContainer.Builder createVoidCreeperAttributes() {
    ...
    protected void dropEquipment(DamageSource source, int lootingMultiplier, boolean allowDrops) {
        ...
        if (entity != this && entity instanceof CreeperEntity creeperEntity) {
            if (creeperEntity.shouldDropHead()) {
                this.dropStack(new ItemStack(InfiniumItems.DUET_MUSIC_DISC));
            }
        }
    ...
    static {
        FUSE_SPEED = DataTracker.registerData(VoidCreeperEntity.class, TrackedDataHandlerRegistry.INTEGER);
        CHARGED = DataTracker.registerData(VoidCreeperEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        IGNITED = DataTracker.registerData(VoidCreeperEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
