...
public class GhoulCreeperEntity extends CreeperEntity implements InfiniumEntity {
    ...
    public static DefaultAttributeContainer.Builder createGhoulCreeperAttributes() {
        return HostileEntity.createHostileAttributes()
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.35)
                .add(EntityAttributes.GENERIC_MAX_HEALTH, 22.0F);
    }
    ...
    static {
        FUSE_SPEED = DataTracker.registerData(GhoulCreeperEntity.class, TrackedDataHandlerRegistry.INTEGER);
        CHARGED = DataTracker.registerData(GhoulCreeperEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        IGNITED = DataTracker.registerData(GhoulCreeperEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
