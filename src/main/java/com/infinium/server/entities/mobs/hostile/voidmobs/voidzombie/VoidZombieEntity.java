package com.infinium.server.entities.mobs.hostile.voidmobs.voidzombie;
...
public class VoidZombieEntity extends HostileEntity implements IAnimatable, InfiniumEntity {
    ...
    public VoidZombieEntity(EntityType<? extends HostileEntity> entityType, World world) {
        super(entityType, world);
        this.setCustomName(ChatFormatter.text("&bVoid Zombie"));
    }
    public static DefaultAttributeContainer.Builder createVoidZombieAttributes() {
    ...
    private <E extends IAnimatable> PlayState playStatePredicateForAttack(AnimationEvent<E> event) {
        if (isPlayingAttackAnimation()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.void_zombie.attack", false));
