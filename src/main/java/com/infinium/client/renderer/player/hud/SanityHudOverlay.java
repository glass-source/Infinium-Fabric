...
public class SanityHudOverlay implements HudRenderCallback {
    ...
    private static final Identifier SANITY_INSIDE = Infinium.id("textures/sanity/cordura_inside.png");
    ...
    public void onHudRender(MatrixStack matrixStack, float tickDelta) {
        ...
        DrawableHelper.drawTexture(matrixStack, x - 54, y - 74 + 9, 0, 0, 16, 48, 16, 48);
