...
public class VoidCreeperEntityRenderer extends MobEntityRenderer<CreeperEntity, InfiniumCreeperEntityModel<CreeperEntity>> {
    ...
    @Environment(EnvType.CLIENT)
    public static class VoidCreeperChargeFeatureRenderer extends EnergySwirlOverlayFeatureRenderer<CreeperEntity, InfiniumCreeperEntityModel<CreeperEntity>> {
        private static final Identifier SKIN = new Identifier(Infinium.MOD_ID, "textures/entity/void_creeper/void_creeper_armor.png");
        private final CreeperEntityModel<CreeperEntity> model;

        public VoidCreeperChargeFeatureRenderer(FeatureRendererContext<CreeperEntity, InfiniumCreeperEntityModel<CreeperEntity>> context, EntityModelLoader loader) {
            super(context);
