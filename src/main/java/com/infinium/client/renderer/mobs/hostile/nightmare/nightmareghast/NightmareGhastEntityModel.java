...
public class NightmareGhastEntityModel extends EntityModel<NightmareGhastEntity> {
	private final ModelPart body;
	private final ModelPart[] tentacles = new ModelPart[9];

	public NightmareGhastEntityModel(ModelPart root) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		body.addChild("face1", ModelPartBuilder.create().uv(8, 37).cuboid(-3.5F, -6.5F + 12, -7.0F, 5.0F, 13.0F, 14.0F, new Dilation(0.1F)), ModelTransform.of(9.5F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0873F));
		body.addChild("face2", ModelPartBuilder.create().uv(32, 32).cuboid(-12F, -5.0F + 12.75f, -2.0F, 8.0F, 7.0F, 8.0F, new Dilation(0.0F)), ModelTransform.of(8.4441F, -7.7756F, 2.0F, -0.1074F, 0.2865F, -0.6264F));
		body.addChild("face3", ModelPartBuilder.create().uv(0, 32).cuboid(0.0F, -3.0F + 12, -1.75F, 6.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(-7.25F, -5.5F, -3.75F, 0.0F, -0.3054F, 0.3054F));
	...
	@Override
	public void setAngles(NightmareGhastEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
		for(int i = 0; i < this.tentacles.length; ++i) {
