...
public class InfiniumTridentItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer, SimpleSynchronousResourceReloadListener {
    ...
    public void reload(ResourceManager manager) {
        ...
        this.tridentModel = new InfiniumTridentEntityModel(mc.getEntityModelLoader().getModelPart(this.modelLayer));
