...
public class InfiniumTridentEntityRenderer extends EntityRenderer<MagmaTridentEntity> {
    private final InfiniumTridentEntityModel model;
    private final Identifier texture;

    public InfiniumTridentEntityRenderer(EntityRendererFactory.Context context, Identifier texture, EntityModelLayer modelLayer) {
        super(context);
        this.model = new InfiniumTridentEntityModel(context.getPart(modelLayer));
    ...
    public Identifier getTexture(MagmaTridentEntity impaledTridentEntity) {
        return this.texture;
    }
}
